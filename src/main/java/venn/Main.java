...
//		this.vennGroup.getChildren().addAll(left, right, intersect);
		...
		VennSectionLeft left = new VennSectionLeft(scene);
		VennSectionRight right = new VennSectionRight(scene);
		VennIntersection intersection = new VennIntersection(scene, left, right);
